        ...
        for (int i = 0; i < invoiceNumbersList.size(); i++){
            ...
            if (c.moveToFirst()) {
                ...
                do {
                    DataInvoice dt = new DataInvoice(salesPartnerNameTmp, accountingTypeTmp, c.getString(itemName),
                            ...
                            Double.parseDouble(c.getString(returnQuantity)), invoiceSumGTmp);
                    dataArray.add(dt);
            ...
            StringRequest request = new StringRequest(Request.Method.POST,
                ...
                public void onResponse(String response) {
                    ...
                    Toast.makeText(getApplicationContext(), "Номер накладной: " + invoiceNumberServerTmp, Toast.LENGTH_SHORT).show();
                    dataArray.clear();
